# Feature Description - just checking
...
![Basic Working of SIFT](https://huggingface.co/datasets/hf-vision/course-assets/blob/main/feature-extraction-feature-matching/Original-SIFT-algorithm-flow.png)
...
![Basic Working of SURF](https://huggingface.co/datasets/hf-vision/course-assets/blob/main/feature-extraction-feature-matching/Flow-Chart-for-SURF-Feature-Detection.png)
